...
def extract_text(files=[], outfile=[],
    ...
    if outfile == []:
        ...
        for outfi in outfile:
            ...
            txt = pdfminer.high_level.extract_text('mlresume/'+fname)
            
            # with codecs.open('mlresume/'+fname, mode="rb") as fp:
            #     txt = pdfminer.high_level.extract_text(fp)

            # with open('mlresume/'+fname, mode="rb") as fp:
